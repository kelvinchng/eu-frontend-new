...
export default function BannerCarousel() {
  ...
  return (
    <div className="relative h-[605px] max-h-[675px] w-full overflow-hidden">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 w-full px-4 flex justify-center">
        <div className="flex flex-col gap-5 sm:gap-6">
          <div className="flex items-baseline ms-1.5 md:ms-2 w-[200px] sm:w-[530px] md:w-[620px] lg:w-[780px] xl:w-[900px] 2xl:w-[1150px] relative font-thunder">
            <h3 className="text-white text-[40px] font-[400] tracking-normal sm:text-[60px] md:text-[70px] lg:text-[90px] xl:text-[100px] 2xl:text-[130px]">
              Book the best travel deals{" "}
            </h3>
            <ArrowUpRight className="size-[40px] sm:size-[60px] md:size-[70px] lg:size-[90px] xl:size-[100px] 2xl:size-[130px] text-white absolute right-6 bottom-3 sm:bottom-4 sm:right-4 md:right-0 md:bottom-5 lg:right-0 xl:right-5 xl:bottom-6 2xl:bottom-7" />
          </div>
          <HeroFilter />
        </div>
      </div>
