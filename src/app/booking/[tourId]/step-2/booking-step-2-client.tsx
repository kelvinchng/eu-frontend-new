...
interface BookingStep2ClientProps {
  tour: any
  tourId: string
}

export function BookingStep2Client({ tour, tourId }: BookingStep2ClientProps) {
  ...
  const handleGoBack = () => {
    ...
    router.push(`/booking/${tourId}/step-1?${params.toString()}`)
  }
        ...
        <div className="px-4 md:px-[60px] lg:px-[80px] xl:px-[110px] 2xl:px-[220px]">
          ...
          <div className="pb-[100px]">
            <div className="flex gap-[60px]">
              ...
              <div className="flex-1 lg:max-w-[835px]">
                ...
                {/* Title with Icon */}
                <div className="flex items-center gap-[9px] md:gap-[12px] mb-[22px] md:mb-[60px]">
                  <Image 
                    src="/assets/icons/bed-icon-title.png"
                    alt="Single bed"
                    width={35}
                    height={39}
                    className="w-[35px] h-[39px] md:w-[43px] md:h-[48px]"
                  />
                ...
                <button
                  onClick={handleGoBack}
                  className="md:hidden w-[102px] h-[45px] bg-white border border-[#242424] rounded-[5px] font-onest text-[13px] text-[#242424] mt-[42px]"
                >
                  Go Back
                </button>
                ...
                <button
                  ...
                  className="md:hidden w-full h-[46px] rounded-[5px] bg-[#242424] text-white font-onest text-[14px] mt-[24px]"
                >
              ...
              <div className="hidden md:hidden lg:block lg:w-[450px] xl:w-[500px] flex-shrink-0">
                ...
                >
                  Proceed to Step 3 – Review and Confirm
                </button>
              </div>
            </div>
          </div>
