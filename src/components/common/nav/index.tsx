...
import { Menu, ChevronRight, CircleChevronRight } from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className={`w-full text-white py-2 relative font-thunder ${
        ...
        <div className="flex items-center justify-between mx-8 ">
          ...
          <div className="relative" ref={dropdownRef}>
            <Button
              variant="ghost"
              size="sm"
              className="text-white hover:bg-transparent hover:text-white/80 text-xl  min-2xl:text-3xl cursor-pointer"
            ...
            {/* Dropdown Menu */}
            {isDropdownOpen && (
              <div className="absolute top-full left-0 mt-6  min-2xl:mt-12 w-auto  min-[800px]:min-w-52  min-[800px]:w-52 min-2xl:w-[329px]  min-[800px]:p-4 bg-navbar border border-navbar/30 rounded-md shadow-lg z-50">
                <div className="py-2 flex w-auto   min-[800px]:flex-col gap-2">
                  {MENU_ITEMS.map((item) => (
                    <button
                      key={item}
                      onClick={() => handleMenuItemClick(item)}
                      className={`flex items-center text-nowrap justify-between w-full p-3 text-left transition-colors ${
                        selectedMenuItem === item
                          ? "text-white bg-black/20"
                          : "text-white hover:bg-black/10"
                      }`}
                    >
                      <span className="text-md  min-2xl:text-3xl">{item}</span>
                      <ChevronRight
                        className={`h-4 w-4 ${
      ...
      {selectedMenuItem && currentTabData && (
        <div
          ref={contentRef}
          className="absolute left-8 min-2xl:left-[365px] min-[800px]:left-[241px] top-[140px] min-2xl:top-[123px] min-[800px]:top-[76px] bg-white rounded-md font-thunder shadow-2xl border border-gray-200 w-[calc(100vw-72px)]  min-[800px]:w-[calc(100vw-300px)] min-2xl:w-[calc(100vw-420px)] h-auto max-h-[500px] z-40"
        >
          {/* Content Header */}
            ...
            <div className="flex space-x-8">
              {availableTabs.map((tab) => (
                <button
                  ...
                  className={`transition-colors text-xl  min-2xl:text-3xl ${
                    currentTabKey === tab
                      ? "text-black"
          ...
          <div className="flex h-full max-h-[350px] font-thunder">
            ...
            <div className="w-56 overflow-y-auto scrollbar">
              <div className="p-4">
                <h3 className="px-1 text-xl  min-2xl:text-3xl text-black">
                ...
                <div className="space-y-1">
                  {currentTabData.regions.map((region) => (
                    <div key={region.name}>
                      ...
                      >
                        <span className="text-base  min-2xl:text-lg font-onest">
                          {region.name}
                        </span>
                        <CircleChevronRight
                          className={`h-4 w-4 ${
            ...
            <div className="flex-1 px-4 py-4 overflow-y-auto scrollbar">
              <div className="mb-6">
                ...
                <div className="flex flex-wrap mb-2">
                  {availableFilters.map((filter) => (
                    <button
                      ...
                      className={`py-1 cursor-pointer px-2 rounded-full text-base  min-2xl:text-lg font-onest transition-colors ${
                ...
                <h3 className="text-md  min-2xl:text-xl px-2 font-pp text-black/80 mb-3">
                ...
                <div className="flex flex-wrap gap-3 w-5/6">
                  {filteredCountries.map((item) => (
                    <button
                      key={item}
                      className="text-left py-1 px-2 w-[150px] hover:bg-navbar hover:text-white rounded transition-colors text-md  min-2xl:text-lg font-onest"
                    >
                      {item}
                    </button>
                  ))}
