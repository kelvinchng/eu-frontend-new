...
interface BookingStep4ClientProps {
  tour: any
  tourId: string
}

export function BookingStep4Client({ tour, tourId }: BookingStep4ClientProps) {
  ...
  const handleGoBack = () => {
    ...
    router.push(`/booking/${tourId}/step-3?${params.toString()}`)
  }
          ...
          <div className="pb-[100px]">
            <div className="flex gap-[60px]">
              ...
              <div className="flex-1 lg:max-w-[840px]">
                ...
                {/* Payment Placeholder */}
                <div className="bg-[#F4F4F4] rounded-[9px] md:rounded-[25px] p-[30px] md:p-[60px]">
                  <h2 className="font-thunder font-medium text-[32px] md:text-[50px] text-[#242424] uppercase leading-[0.92] mb-[30px] md:mb-[50px]">
                    Payment
                  </h2>
                  
                  <div className="text-center py-[60px] md:py-[100px]">
                    <div className="mb-[30px]">
                      <svg className="w-[80px] h-[80px] md:w-[120px] md:h-[120px] mx-auto text-[#242424]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                      </svg>
                    </div>
                    
                    <h3 className="font-onest font-semibold text-[18px] md:text-[24px] text-[#242424] mb-[16px]">
                      Payment Gateway Integration
                    </h3>
                    
                    <p className="font-onest text-[14px] md:text-[18px] text-[#666666] max-w-[500px] mx-auto">
                      This is where the payment gateway would be integrated. Users would enter their payment details and complete the booking.
                    </p>
                    
                    <div className="mt-[40px] space-y-[20px]">
                      <p className="font-onest text-[13px] md:text-[16px] text-[#666666]">
                        Total Amount: <span className="font-bold text-[#242424]">${subtotal.toLocaleString()}.00</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="md:hidden mt-[42px] space-y-[24px]">
                  ...
                  <button
                    className="w-full h-[46px] rounded-[5px] bg-[#242424] text-white font-onest text-[14px] opacity-50 cursor-not-allowed"
                    disabled
                  >
                    Complete Payment
                  </button>
              ...
              <div className="hidden md:hidden lg:block lg:w-[450px] xl:w-[500px] flex-shrink-0">
                ...
                <button
                  className="w-full h-[52px] rounded-[9px] font-onest text-[18px] mt-[74px] bg-gray-400 text-white cursor-not-allowed"
                  disabled
                >
                  Complete Payment
                </button>
