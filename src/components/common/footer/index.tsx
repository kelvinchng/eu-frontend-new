...
export function Footer() {
  return (
    <footer className="w-full bg-[#242424] text-white">
      <div className="w-full px-[25px] md:px-[55px] py-[47px] md:pt-[70px] md:pb-[55px] flex flex-col">
        {/* Mobile Layout */}
        <div className="md:hidden flex flex-col">
          {/* Links Section */}
          <div className="mb-[50px]">
            <h3 className="font-thunder font-normal text-[25px] leading-[30px] mb-[10px]">Links</h3>
            <div className="space-y-0">
              <Link href="/" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Home
              </Link>
              <Link href="/our-story" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Our Story
              </Link>
              <Link href="/partners" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Our Partners
              </Link>
              <Link href="/careers" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Careers
              </Link>
              <Link href="/press-media" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Press & Media
              </Link>
              <Link href="/contact" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Contact Us
              </Link>
            </div>
          </div>
          ...
          {/* Explore Section */}
          <div className="mb-[50px]">
            <h3 className="font-thunder font-normal text-[25px] leading-[30px] mb-[12px]">Explore</h3>
            <div className="space-y-0 ml-[4px]">
              <Link href="/trending" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Trending Destinations
              </Link>
              <Link href="/themed-journeys" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Themed Journeys
              </Link>
              <Link href="/cruises" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Cruises
              </Link>
              <Link href="/deals" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Last-Minute Deals
              </Link>
            </div>
          </div>
          ...
          <div className="mb-[34px]">
            <h3 className="font-thunder font-normal text-[25px] leading-[30px] mb-[10px]">Policies</h3>
            <div className="space-y-0">
              <Link href="/terms" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Terms and Conditions
              </Link>
              <Link href="/cancellation" className="block font-onest text-[14px] leading-[20px] hover:opacity-80 transition-opacity">
                Cancellation and Refunds
              </Link>
              <Link href="/privacy" className="block font-onest text-[14px] leading-[30px] hover:opacity-80 transition-opacity">
                Privacy Policy
              </Link>
            </div>
          </div>
          ...
          {/* Find Us Section */}
          <div className="mb-12">
            <h3 className="font-thunder font-normal text-[25px] leading-[30px] mb-[10px]">Find Us</h3>
            <p className="font-onest text-[14px] leading-[30px] mb-[16px]">Social Media</p>
            
            {/* Social Icons */}
            <div className="flex items-center gap-[15.55px] mb-[17px]">
              <Link 
            ...
            <div className="space-y-[9px]">
              <p className="font-onest text-[14px] leading-[30px]">+65 6958 8888</p>
              <p className="font-onest text-[14px] leading-[30px]">1 Raffles Blvd, Level 2 Crescent 2,<br />039593</p>
              <p className="font-onest text-[14px] leading-[30px]">Monday to Sunday, 11AM to 8PM</p>
            </div>
          </div>
          
          {/* Divider */}
          <div className="w-full h-0 border-t border-[#5C5C5C] mb-[16px]" />
          
          {/* Copyright */}
          <p className="font-onest text-[14px] leading-[30px] text-center px-[14px]">
            © 2025 EU Holidays Pte Ltd. All rights reserved.
          </p>
        </div>

        {/* Desktop Layout */}
        <div className="hidden md:flex flex-col gap-[81.39px]">
          {/* Main Content */}
